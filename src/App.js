...
function App() {
  ...
  return (
    <div>
      <Navbar search = {search} setSearch = {setSearch} rate = {rate}  setRate = {setRate}    >  </Navbar>
        {/* <Rating  rate = {rate} setRate = {setRate} /> */}
      <Add moviedata={moviedata} setmoviedata={setmoviedata} />
      <ListMovies search = {search} moviedata={moviedata} setmoviedata={setmoviedata} rate = {rate} />
    </div>
  )
}
